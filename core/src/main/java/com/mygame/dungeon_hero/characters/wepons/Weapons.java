...
public enum Weapons {
    ...
    AXE("Топор",2, PIERCING, Assets.getRegion(AtlasType.WEAPON, "axe")),
    SPEAR("Копье",2, PIERCING, Assets.getRegion(AtlasType.WEAPON, "spear")),
    LEGENDARY("Легендарный меч",2, PIERCING, Assets.getRegion(AtlasType.WEAPON, "legendary"));
